...
//     CREATE RECYCLER VIEW FOR TRANSACTIONS
        RecyclerView recyclerView = V.findViewById(R.id.Transactions);
        ...
        database.child("Users").child(firebaseAuth.getUid()).addValueEventListener(
                new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if(CurrUser!=null) {
                            double WalletBalance = CurrUser.getWalletBalance();
                            TextView Wallet = V.findViewById(R.id.balance);
                            Wallet.setText("Rs. " + WalletBalance);
                        }
                    }
                    @Override
