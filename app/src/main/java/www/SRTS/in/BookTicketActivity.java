...
public class BookTicketActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    public void ScanQR(View view) {
        adults = Adults.getText().toString();
        ...
        selectedClass = findViewById(Class.getCheckedRadioButtonId());
        tclass = selectedClass.getText().toString().trim();

        selectedTripType = findViewById(TripType.getCheckedRadioButtonId());
        triptype = selectedTripType.getText().toString().trim();


            Intent i = new Intent(this,QRScannerActivity.class);
            ticket = new Ticket();
            ticket.setDestination(destination);
            ticket.setAdults(Integer.parseInt(adults));
            ticket.setChildren(Integer.parseInt(child));
            ticket.setReturn(triptype);
            ticket.setCategory(tclass);
